...
// Backwards-compatible alias for code that expects a `Student` type
...
export type Attendance = {
    ...
    reason?: string;
  // serverTimestamp() returns a sentinel value that is not a Timestamp at compile-time,
  // allow either a real Timestamp or the sentinel (any) to avoid type errors when writing.
